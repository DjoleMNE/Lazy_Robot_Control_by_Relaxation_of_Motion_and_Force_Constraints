...
plt.subplot(7, 1, 2)
plt.plot(joint_1, c = 'green', label='joint_2', linewidth = 0.5, zorder = 3)
...
plt.subplot(7, 1, 3)
plt.plot(joint_2, c = 'green', label='joint_3', linewidth = 0.5, zorder = 3)
...
plt.subplot(7, 1, 4)
plt.plot(joint_3, c = 'green', label='joint_4', linewidth = 0.5, zorder = 3)
...
plt.subplot(7, 1, 5)
plt.plot(joint_4, c = 'green', label='joint_5', linewidth = 0.5, zorder = 3)
...
plt.subplot(7, 1, 6)
plt.plot(joint_5, c = 'green', label='joint_6', linewidth = 0.5, zorder = 3)
...
plt.subplot(7, 1, 7)
plt.plot(joint_6, c = 'green', label='joint_7', linewidth = 0.5, zorder = 3)
