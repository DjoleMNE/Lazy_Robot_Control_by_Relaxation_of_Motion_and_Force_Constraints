...
plt.subplot(7, 1, 1)
plt.plot(joint_0, c = 'green', label='joint_1_torque', linewidth = 0.5, zorder = 3)
...
plt.subplot(7, 1, 2)
plt.plot(joint_1, c = 'green', label='joint_2_torque', linewidth = 0.5, zorder = 3)
...
plt.subplot(7, 1, 3)
plt.plot(joint_2, c = 'green', label='joint_3_torque', linewidth = 0.5, zorder = 3)
...
plt.subplot(7, 1, 4)
plt.plot(joint_3, c = 'green', label='joint_4_torque', linewidth = 0.5, zorder = 3)
...
plt.subplot(7, 1, 5)
plt.plot(joint_4, c = 'green', label='joint_5_torque', linewidth = 0.5, zorder = 3)
...
plt.subplot(7, 1, 6)
plt.plot(joint_5, c = 'green', label='joint_6_torque', linewidth = 0.5, zorder = 3)
...
plt.subplot(7, 1, 7)
plt.plot(joint_6, c = 'green', label='joint_7_torque', linewidth = 0.5, zorder = 3)
