...
namespace youbot_constants
{
   ...
   //  const std::string urdf_path = "/home/djole/Master/Thesis/GIT/MT_testing/Controller/urdf/youbot-ver-azamat.urdf";
...
namespace dynamics_parameter
{
    ...
    const std::vector<double> MAX_FORCE{40.0, 40.0, 40.0, 20.0, 20.0, 20.0};
