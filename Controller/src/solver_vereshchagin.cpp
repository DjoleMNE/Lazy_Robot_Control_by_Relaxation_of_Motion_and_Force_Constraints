...
void Solver_Vereshchagin::constraint_calculation(const JntArray& beta)
{
    ...
    /*
        Djordje: Here, the gravity acc vector is added to be accounted as a constraint on the base link.
    ...
    */ 
    ...
    /*
        Djordje: Add task specified acceleration energy.
    */
    nu_sum += beta.data;

    /*
        Djordje: Add acceleration energy generated by 
        all other natural forces in the system.
    */
    nu_sum -= results[0].G;
