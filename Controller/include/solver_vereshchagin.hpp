...
public:
     ...
     */
    int CartToJnt(const JntArray &q, const JntArray &q_dot, JntArray &q_dotdot, const Jacobian& alfa, const JntArray& beta, const Wrenches& f_ext_natural, const Wrenches& f_ext_virtual, JntArray &torques);
...
private:
     ...
     */
    void initial_upwards_sweep(const JntArray &q, const JntArray &q_dot, const JntArray &q_dotdot,  const Wrenches& f_ext_natural, const Wrenches& f_ext_virtual);
    /**
